...
export const EditForm = (id)=>{
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          ...
          const response = await axios.patch(
            `http://localhost:8080/product/${id.id}`, // Replace with your actual API endpoint and ID parameter
            edit
          );
    ...
    return(
        <Box bgColor={'#fff'} className="blurr content" zIndex={'5'} position={'fixed'} left={'30%'} top={'4%'} w={'40%'} p={'5'} alignItems={'center'} textAlign={'center'} m={'auto'}>
            ...
            <form onSubmit={handleSubmit}>
                <Input mb={'3'} value={edit.image} placeholder="Enter image url.." type="url" name="image" onChange={handleChange}/>
                <Input mb={'3'} value={edit.title1} placeholder="enter title1.." type="text" name="title1" onChange={handleChange}/>
                <Input mb={'3'} value={edit.title2} placeholder="enter title2" type="text" name="title2" onChange={handleChange}/>
                <Input mb={'3'} value={edit.title3} placeholder="enter title3" type="text" name="title3" onChange={handleChange}/>
                <Input mb={'3'} value={edit.title4} placeholder="enter title4" type="text" name="title4" onChange={handleChange}/>
                <Input mb={'3'} value={edit.offer} placeholder="Enter offer" type="text" name="offer" onChange={handleChange}/>
                <Input mb={'3'} value={edit.quantity} placeholder="Enter quantity" type="number" name="quantity" onChange={handleChange}/>
                <Input mb={'3'} value={edit.price} placeholder="Enter price" type="number" name="price" onChange={handleChange}/>
